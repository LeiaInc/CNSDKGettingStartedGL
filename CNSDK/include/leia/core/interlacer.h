#ifndef CNSDK_LEIA_CORE_INTERLACER_H
#define CNSDK_LEIA_CORE_INTERLACER_H
...
enum {
    LEIA_INTERLACER_MAX_LAYERS = 16, ///< A compile-time hint, use leia_interlacer_get_max_layer_count to get the actual value
    LEIA_INTERLACER_MAX_VIEWS  = 12, ///< A compile-time hint, use leia_interlacer_get_max_view_count to get the actual value
};

/**
 * @brief Gets the max number of layers that can be interlaced at once.
 *
 * @public @memberof leia_interlacer
 */
LEIASDK_API
int32_t leia_interlacer_get_max_layer_count(struct leia_interlacer*);

/**
 * @brief Gets the max number of views per layer that can be interlaced at once.
 *
 * @public @memberof leia_interlacer
 */
LEIASDK_API
int32_t leia_interlacer_get_max_view_count(struct leia_interlacer*);
...
/**
 * @brief Set the origin and scale of the zoom plate
 *
 * Use this method to set the zoom plate, i.e. the raw values for zoom & pan gesture handling
 *
 * @param[in] posX,posY,scaleX,scaleY The raw x, y, absoluteZoomX, absoluteZoomY
 *
 * @public @memberof leia_interlacer
 */
LEIASDK_API
void leia_interlacer_set_zone_plate(struct leia_interlacer*, float posX, float posY, float scaleX, float scaleY);
...
/**
 * @brief Set whether view textures are in a sRGB format.
 *
 * @param[in] isSRGB Set to true if view textures are in a sRGB format.
 *
 * @public @memberof leia_interlacer
 */
LEIASDK_API
void leia_interlacer_set_source_views_srgb(struct leia_interlacer*, leia_bool isSRGB);

/**
 * @brief Set whether to sRGB conversions are enabled or disabled in the interlacing shader.
 *
 * @param[in] sRGBRead  Set to true to enable sRGB conversion when reading view texture.
 * @param[in] sRGBWrite  Set to true to enable sRGB conversion when writing to render-target.
 *
 * @public @memberof leia_interlacer
 */
LEIASDK_API
void leia_interlacer_set_in_shader_srgb_conversion(struct leia_interlacer*, leia_bool sRGBRead, leia_bool sRGBWrite);
 ...
 * depending on the value set via leia_interlacer_set_reconvergence().
 *
 * @see leia_interlacer_is_reconvergence_enabled, leia_interlacer_get_reconvergence, leia_interlacer_set_reconvergence, leia_interlacer_set_reconvergence_zoom
 *
 ...
 *
 * @see leia_interlacer_get_reconvergence, leia_interlacer_enable_reconvergence, leia_interlacer_set_reconvergence, leia_interlacer_set_reconvergence_zoom
 *
 ...
 *
 * @see leia_interlacer_is_reconvergence_enabled, leia_interlacer_enable_reconvergence, leia_interlacer_set_reconvergence,
 ...
 * and vertically.
 *
 * @see leia_interlacer_get_reconvergence, leia_interlacer_is_reconvergence_enabled, leia_interlacer_enable_reconvergence, leia_interlacer_set_reconvergence
 *
 ...
 */
LEIASDK_API
void leia_interlacer_initialize_gui(struct leia_interlacer*, struct leia_interlacer_debug_menu_configuration const* config, leia_bool sRGB);
 ...
 */
LEIASDK_API
struct leia_interlacer_gui_input_state leia_interlacer_process_gui_input_wndproc(
    struct leia_interlacer*, void* surface, uint32_t msg, uint64_t wparam, int64_t lparam);
 ...
 */
LEIASDK_API
struct leia_interlacer_gui_input_state leia_interlacer_process_gui_input_ndk(struct leia_interlacer*, struct AInputEvent const* inputEvent);
...
#endif // CNSDK_LEIA_CORE_INTERLACER_H
